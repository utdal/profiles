    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container-fluid">
          ...
          {{ html()->label('Tags:', $id.'_tags[]')->id('tags-picker-label')->class('form-label') }}
          {{ html()->select($id.'_tags[]', $tags
                      ->pluck('name','name')
                      ->all(), null)
                      ->id($id.'_tags[]')
                      ->multiple()
                      ...
                      ->data('model-name', $id)
                      ->data('url', route('tags.api.update'))
                      ->data('model-id', $model
                      ->getKey())
                      ->data('model', $model_class)
                      ->aria('labelledby', 'tags-picker-label') }}
        </div>
      </div>
