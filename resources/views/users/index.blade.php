...
<div class="container">
    ...
    <div class="search input-group input-group-lg">
        <input id="user_search" class="search form-control" type="search" name="user_search" placeholder="search..." aria-label="Search" value="{{$user_search}}">
        <div class="input-group-append">
        <button class="btn btn-success" type="submit" data-toggle="replace-icon" data-newicon="fas fa-sync fa-spin" data-inputrequired="#user_search">
