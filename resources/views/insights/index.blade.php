...
@section('content')
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane active" id="student-applications">
        ...
        <div><livewire:insights.student-apps-count-chart :selected_semesters="$semesters_selected" :selected_schools="$schools_options"/></div>
        <div><livewire:insights.student-apps-filing-status-chart :selected_semesters="$semesters_selected" :selected_schools="$schools_options"/></div>
