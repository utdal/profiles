...
class StudentPolicy
{
    ...
    /**
     * Determine whether the user can view all feedback on the student.
     *
     * @param  \App\User  $user
     * @param  \App\Student  $student
     * @return mixed
     */
    public function viewFeedback(User $user, Student $student)
    {
    ...
    {
        return $user->hasRole(['student', 'students_admin']);
    }
