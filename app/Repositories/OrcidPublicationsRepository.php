    ...
    public function getPublications() : Collection|false
    {
        ...
        foreach ($split_putcodes as $putcodes_set) {
            ...
            foreach ($putcodes_works_data['bulk'] as $record) {
                ...
                $authors = $this->getPublicationAuthors($record);
                ...
                $profile_data = new ProfileData([
                    ...
                    'data' => [
                        ...
                        'url' => $this->getPublicationReferences($record)['url'],
                        ...
                        'doi'  => $this->getPublicationReferences($record)['doi'],
                        'eid' => $this->getPublicationReferences($record)['eid'],
                        'authors' => $authors,
                        'authors_formatted' => [
