"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["/js/profiles-charts"],{

/***/ "./resources/assets/js/modules/profiles-charts-plugins.js":
/*!****************************************************************!*\
  !*** ./resources/assets/js/modules/profiles-charts-plugins.js ***!
  \****************************************************************/
...
/* harmony export */   highlightTickPlugin: () => (/* binding */ highlightTickPlugin),
/* harmony export */   progressTextPlugin: () => (/* binding */ progressTextPlugin),
/* harmony export */   toggleTooltipPlugin: () => (/* binding */ toggleTooltipPlugin),
/* harmony export */   validateEmptyDataPlugin: () => (/* binding */ validateEmptyDataPlugin)
/* harmony export */ });
function getChartData(data, labels) {
  var bg_color = ['#56CC9F', '#E0E0E0'];
...
var progressTextPlugin = {
  ...
  afterDraw: function afterDraw(chart) {
    ...
    total = data.datasets[0].data.reduce(function (sum, value) {
      return sum + value;
    }, 0);
    if (total === 1) {
      var no_data_text = 'No results found \n for the selected filters \n 😭';
      var lines = no_data_text.split('\n');
      ...
      ctx.fillText("".concat(progress_percentage, "%"), xCoor, yCoor);
    }
  }
};
var highlightTickPlugin = {
  id: 'highlightTick',
  beforeDraw: function beforeDraw(chart) {
    var ctx = chart.ctx;
    ...
    xAxis.ticks.forEach(function (tick, index) {
      var label = xAxis.getLabelForValue(tick.value);
      var xPixel = xAxis.getPixelForValue(tick.value);
      var totalTicks = xAxis.ticks.length;
      var barWidth = xAxis.width / totalTicks;
      var xLeft = xPixel - barWidth / 2;
      var chartHeight = yAxis.bottom - yAxis.top;
...
/***/ "./resources/assets/js/profiles-charts.js":
/*!************************************************!*\
  !*** ./resources/assets/js/profiles-charts.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _modules_profiles_charts_plugins_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/profiles-charts-plugins.js */ "./resources/assets/js/modules/profiles-charts-plugins.js");
...
window.getChartData = _modules_profiles_charts_plugins_js__WEBPACK_IMPORTED_MODULE_2__.getChartData;
window.toggleTooltipPlugin = _modules_profiles_charts_plugins_js__WEBPACK_IMPORTED_MODULE_2__.toggleTooltipPlugin;
window.progressTextPlugin = _modules_profiles_charts_plugins_js__WEBPACK_IMPORTED_MODULE_2__.progressTextPlugin;
window.highlightTickPlugin = _modules_profiles_charts_plugins_js__WEBPACK_IMPORTED_MODULE_2__.highlightTickPlugin;
window.validateEmptyDataPlugin = _modules_profiles_charts_plugins_js__WEBPACK_IMPORTED_MODULE_2__.validateEmptyDataPlugin;
...
/******/ var __webpack_exports__ = (__webpack_exec__("./resources/assets/js/profiles-charts.js"));
/******/ }
]);
//# sourceMappingURL=profiles-charts.js.map